...
## Overview
This project automates the creation of a weekly athlete monitoring report using GPS and wellness data. The purpose was to give coaching staff a high-level overview of team workload and recovery trends to help inform weekly planning and periodization decisions in a simple printable format.
...
![Weekly training report screenshot](weekly_report.png)